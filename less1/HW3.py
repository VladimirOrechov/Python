...
# n = int(input("введите количество числе в массиве ")) # запрашиваем количество чисел в массиве

# arr = []  # создаем массив

# for i in range(n):  
#     arr.append(randint(1, 9))  # добавляем рандомный макссив со значениями от 1 до 9 включительно
# print(arr) 

# k = int(input("введите искомое числе в массиве ")) #
# count = 0 #
